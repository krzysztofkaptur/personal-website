      ...
      <section className='flex h-screen gap-8'>
        <div className='flex flex-1 flex-col gap-6'>
          ...
          <p>
            ...
            quidem iste ipsum culpa nobis omnis? Aperiam optio odit eius in
            natus sit impedit, tempore aspernatur unde enim ab magnam deleniti
            incidunt, minima dolor, vel dicta. Quis quasi consectetur earum
            totam.
          </p>
        </div>
